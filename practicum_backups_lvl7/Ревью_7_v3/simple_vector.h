...
public:
    ...
    Iterator Erase(Iterator position) noexcept;//Сам Erase вынесен за пределы класса
...
template <typename Type>
typename SimpleVector<Type>::Iterator SimpleVector<Type>::Erase(typename SimpleVector<Type>::Iterator position) noexcept {
